...
<body>
	...
	<div id='wrapper' class='container_12 clearfix'>
		...
		Outprint a pdf file or a basic table? Has to change based on how many variables were input. Parse input file using python and R to determine.
		
		<p>File uploaded to a random folder ID %s</p>
		...
		<div id='quicknav' class='grid_12'>
			...
			<a class='quicknavgrid_3 quicknav' href='files/%s/output.csv'>
