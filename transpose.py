...
function showSelected()
{
	...
	<div id='wrapper' class='container_12 clearfix'>
		...
		<a href='indexTWO.html'><img align='left' width='234' height='45' style="padding-top:40px;padding-left:20px;" src='../../images/logo.png' ></a>
		...
		<form enctype='multipart/form-data' action='transpose.py'  method='post'>
		...
		<br> 
		<h4 class='grid_12 caption clearfix' align='center' style="margin:0px auto;padding-bottom:20px;">If your data is incorrect, please correct your data and <a href='index.html'>reupload your file.</a></h4>
		<br> 
		<br> 
		<br> 
		<br> 
	...
	<div class='hero-unit'> <!-- old box is id='options' -->
			...
			<img align='right' style="margin-right:30px;padding-top:0px;padding-bottom:0px" width='180' height='232' src='../../images/processnow.png'>
			<form enctype='multipart/form-data' action='../../process.py'  method='post'>
