...
newPath = 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/' + folderID + '_Page.html'
path2 = 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/Agram.png'
pathAgraph = 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/Agraph.png'
pathvisu = 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/' + folderID + '_visualize.html'
...
<head>
	...
	<link rel="stylesheet" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/css/reset.css" />
	<link rel='stylesheet' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/css/d3.css' />
	<link rel='stylesheet' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/css/styles.css' />
	

	<!-- Scripts -->
	<!-- JQUERY LOADING SCREEN SCRIPT -->
	<script type="text/javascript" src="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/js/jquery-1.7.2.min.js"></script>
			...
			var refreshImage = setInterval(function() 
			{
				...
				error:
				  function()
				  {
						...
						imgDest.setAttribute('src', 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/loader2.gif');
	...
	<!-- Fancybox stuff-->
	<link rel='stylesheet' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/js/jquery.fancybox.css' type='text/css' media='screen' />
	 <!--script type='text/javascript' src='http://jquery-ui.googlecode.com/svn/trunk/jquery-1.4.2.js'></script-->
	 <script type='text/javascript' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/js/jquery.fancybox.pack.js'></script>
	 
	 <!-- Add Buttons -->
	<link rel="stylesheet" type="text/css" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/js/jquery.fancybox-buttons.css" />
	<script type="text/javascript" src="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/js/jquery.fancybox-buttons.js"></script>
...
<body>
	...
	<div id='wrapper' class='container_12 clearfix'>
		...
		<!-- Text Logo -->
		<a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/index.html'><img id='logo' width='250' height='86' align='left' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/logo.jpg' ></a>
		<!-- h1 id='logo' class='grid_4'>Maatie</h1 -->
		
		<!-- Navigation Menu -->
		<ul id='navigation' class='grid_8'>
			
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/contact.html'><span class='meta'>Get in touch</span><br />Contact us</a></li>
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/news.html'><span class='meta'>Citations</span><br />News</a></li>
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/help.html'><span class='meta'>Formatting</span><br />Help</a></li>
				
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/about.html'><span class='meta'>The method</span><br />About</a></li>
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/index.html' class='current'><span class='meta'>Analyze data</span><br />Upload</a></li>
		...
		<img id='ok' alt=''  align='left' style='margin-left:120px;padding-top:0px;padding-bottom:0px' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/loader2.gif' height='231' width='231' />
				 ...
				 $.ajax
						 ({	   
							...
							function()
							{
									...
									var imgDest = document.getElementById('ok');
									$("#ok").fadeOut('slow');
									imgDest.setAttribute('src', 'http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/completeA.png');
	...
	<!-- The gallery of images for help -->
		...
		<a class="fancybox" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/b.png" data-fancybox-group="gallery" title="Adjacency Matrix"><b>Click here for more help with understanding this graph.</b></a>

		<a class="fancybox" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/c.png" data-fancybox-group="gallery" title="Colour"></a>

		<a class="fancybox" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/d.png" data-fancybox-group="gallery" title="Diagonals"></a>
		
		<a class="fancybox" href="http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/a.png" data-fancybox-group="gallery" title="Diagonals"></a>
		...
		<div id='quicknav' class='grid_12'>
			<a class='quicknavgrid_3 quicknav alpha' href='""" + pathvisu + """'>
					...
					<p style='text-align:center;'><img alt='' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/visu.png' /></p>
			...
			<a class='quicknavgrid_3 quicknav' href='output.csv'>   <!-- Downloads the output.csv stored in the random folder -->
					...
					<p style='text-align:center;'><img alt='' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/dl.png' /></p>
				
			</a>
			<a class='quicknavgrid_3 quicknav' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/index.html'>
					...
					<br />
					<br />
					<p style='text-align:center;'><img alt='' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/again.png' /></p>
				
			</a>
			<a class='quicknavgrid_3 quicknav' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/help.html'>
					<h4 class='title '>Help</h4>
					<p>Need help understanding the results? [Link to popout page with image] </p>
					<br />
					<br />
					<p style='text-align:center;'><img alt='' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/anahelp.png' /></p>
			</a>
		</div>
...
<head>
	...
	<link type='text/css' href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/css/tabs.css' rel='stylesheet' />	
...
<body>
	...
	<div id='wrapper' class='container_12 clearfix'>
		...
		<!-- Text Logo -->
	<a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/index.html'><img align='left' width='250' height='86' src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/logo.jpg' ></a>
		...
		<ul id='navigation' class='grid_8'>
			...
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/help.html'><span class='meta'>Formatting</span><br />Help</a></li>
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/about.html'><span class='meta'>The method</span><br />About</a></li>
			<li><a href='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/index.html'><span class='meta'>Analyze data</span><br />Upload</a></li>
		</ul>
		...
		<div class='grid_12'>
			...
			<div id='tabs'>
				<ul>
					...
					<li><a href='#tabs-4'>Force Directed Graph</a></li>
				...
				<div id='tabs-3'>
							...
							<div id='FDG' style="text-align: center;">
										...
										d3.json("adj3.json", function(json) {
											var force = self.force = d3.layout.force()
												...
												.charge(-100)
												  .linkDistance(function(d) {return (25/(d.value+0.05));})
					...
					<div id='tabs-5'>
							...
							<div id='table' style="height:300px; overflow:scroll">
		...
		<div class='grid_12'>
			...
			<p align='center'><img src='http://ec2-175-41-179-225.ap-southeast-1.compute.amazonaws.com/images/visubot.png'></p>
