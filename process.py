...
folderID = form['id'].value
dropdown = form['dropdown'].value
dropdownSelected = form['selectedIndex'].value
...
if method =="one": #OVE
	textFileName = "consoleOutOVR.txt"
	csvName =  "outputOVR.csv"
elif method =="pairs":
	textFileName ="consoleOut.txt"
	csvName ="output.csv"
	csvName = "output.csv"
else:
	textFileName ="consoleOut.txt"
...
newPath = 'http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/' +  'ResultsPage' +method+'.html'
...
pathvisu = 'http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/files/' + folderID + '/' + 'Visualize.html'

#======== The first loading page ============

open('files/' + folderID + '/'  + 'ResultsPage'+method+'.html', 'wb').write("""<!DOCTYPE html><html>
<head>
...
<body>
	...
	<div id='wrapper' class='container_12 clearfix'>
		...
		<!-- Text Logo -->
		<a href='http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/index.html'><img align='left' width='234' height='45' style="padding-top:40px;padding-left:20px;" src='http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/logo.png' ></a>
						 ...
						 ({	   
							...
							function()
							{
									...
									$("#subtext").fadeOut("slow");					 
									 d3.text('"""+csvName+"""', function(datasetText) {
	...
	<!-- The gallery of images for help -->
		...
		<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/a.jpg" data-fancybox-group="gallery" title="Image 1 of 4 - Adjacency Matrix"><b>Click here for more help with understanding this graph.</b></a>

		<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/b.jpg" data-fancybox-group="gallery" title="Image 2 of 4 - Diagonals"></a>

		<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/c.jpg" data-fancybox-group="gallery" title="Image 3 of 4 - Colour"></a>
		
		<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/d.jpg" data-fancybox-group="gallery" title="Image 4 of 4- Opacity"></a>
		...
		<div id='quicknav' class='grid_12'>
			...
			<a class='quicknavgrid_3 quicknav' href='"""+csvName+"""'>   <!-- Downloads the output.csv stored in the random folder -->
			...
			<a class=" quicknavgrid_3 quicknav help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/resultshelp.jpg" data-fancybox-group="galleryx" title="Image 1 of 1 - Results Page">
...
open('files/' + folderID + '/'  + 'Visualize.html', 'wb').write("""
<head>
			...
			<div id='tabs'>
				...
				<div id='tabs-1'>
					...
					<br />
							<div id='FDG' style="text-align: center;"> 
										...
										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/forcea.jpg" data-fancybox-group="gallery1" title="Image 1 of 5 - Force Directed Graph"><b>Click here for help with understanding this graph.</b></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/forceb.jpg" data-fancybox-group="gallery1" title="Image 2 of 5 - Edges I"></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/forcec.jpg" data-fancybox-group="gallery1" title="Image 3 of 5 - Edges II"></a>
										
										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/forced.jpg" data-fancybox-group="gallery1" title="Image 4 of 5 - Edges III"></a>
										
										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/forcee.jpg" data-fancybox-group="gallery1" title="Image 5 of 5 - Clustering"></a>
				...
				<div id='tabs-2' height='400'>
					...
					<div id='options' style="text-align: center;">
							...
							<br />
							 <h2 class='caption clearfix' style="text-align:center;">Help</h2>
									<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agraph1.jpg" data-fancybox-group="gallery2" title="Image 1 of 3 - AGraph"><b>Click here for help with understanding this graph.</b></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agraph2.jpg" data-fancybox-group="gallery2" title="Image 2 of 3 - Clustering"></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agraph3.jpg" data-fancybox-group="gallery2" title="Image 3 of 3 - Colour"></a>
				...
				<div id='tabs-3'>
					 ...
					 <script>
							...
							<div id='options' style="text-align: center;">
									...
									<h2 class='caption clearfix' style="text-align:center;">Help</h2>
										...
										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/a.jpg" data-fancybox-group="gallery3" title="Image 1 of 4 - Adjacency Matrix"><b>Click here for more help with understanding this graph.</b></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/b.jpg" data-fancybox-group="gallery3" title="Image 2 of 4 - Diagonals"></a>

										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/c.jpg" data-fancybox-group="gallery3" title="Image 3 of 4 - Colour"></a>
										
										<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/d.jpg" data-fancybox-group="gallery3" title="Image 4 of 4- Opacity"></a>
					...
					<div id='options' style="text-align: center;">
						...
						<h2 class='caption clearfix' style="text-align:center;">Help</h2>
							...
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram1.jpg" data-fancybox-group="gallery4" title="Image 1 of 7 - Agram"><b>Click here for help with understanding this graph.</b></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram2.jpg" data-fancybox-group="gallery4" title="Image 2 of 7 - Scatter Plot I"></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram3.jpg" data-fancybox-group="gallery4" title="Image 3 of 7 - Scatter Plot II"></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram4.jpg" data-fancybox-group="gallery4" title="Image 4 of 7 - Pie Graph I"></a>										
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram5.jpg" data-fancybox-group="gallery4" title="Image 5 of 7 - Pie Graph II"></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram6.jpg" data-fancybox-group="gallery4" title="Image 6 of 7 - Pie Graph III"></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram7.jpg" data-fancybox-group="gallery4" title="Image 7 of 7 - Pie Graph IV"></a>
							<a class="help" href="http://ec2-122-248-225-29.ap-southeast-1.compute.amazonaws.com/images/agram1.jpg" data-fancybox-group="gallery4" title="Image 7 of 7 - Pie Graph V"></a>
...
if (method=="one"):
	os.system("nohup R --vanilla --slave --args "+folderID+" " +dropdownSelected+" < OneVsRest.R > /var/www/files/"+folderID+"/consoleOutOVR.txt &")
elif (method=="pairs"):
	os.system("nohup R --vanilla --slave --args " +folderID + "< datProc.R > /var/www/files/" +folderID + "/consoleOut.txt &")
elif (method=="exp"):
	os.system("nohup R --vanilla --slave --args "+folderID+" < datProc.R > /var/www/files/"+folderID+"/consoleOut.txt &") #To implement
elif (method=="oneshot"):
	os.system("nohup R --vanilla --slave --args "+folderID+" < datProc.R > /var/www/files/"+folderID+"/consoleOut.txt &") #To implement
